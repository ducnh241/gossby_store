...
class Controller_Frontend_Backend extends Abstract_Backend_Controller
{
    ...
    public function actionUploadImage() {
        if (!$this->checkPermission('frontend/collection', false)) {
        ...
        try {
            ...
            $file_name = 'section.' . $this->getAccount()->getId() . '.' . OSC::makeUniqid() . '.' . $extension;
