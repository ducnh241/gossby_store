 ...
 */
class Model_Catalog_Order_ConfirmShipping extends Abstract_Core_Model {
    const _DB_BIN_READ = 'db_master';
    const _DB_BIN_WRITE = 'db_master';
    protected $_table_name = 'catalog_order_confirm_shipping';
    protected $_pk_field = 'record_id';
    protected $_ukey_field = 'token';

    const CONFIRM_SHIPPING_WAIT_TO_USE = 0;
    const CONFIRM_SHIPPING_USED = 1;
    CONST TBL_QUEUE_NAME = 'catalog_order_confirm_shipping';
