 ...
 */
class Model_Shipping_Rate extends OSC_Database_Model {

    /**
     *
     * @var string
     */
    protected $_table_name = 'shipping_rate';
    ...
    const SHIPPING_RATE_DYNAMIC = 1;
    const SHIPPING_RATE_STATIC = 0;
    ...
    public function getRatePriceByLocationData($product_type_ids = [], $product_type_variant_ids = [], $country_id = '', $province_id = ''){
        ...
        $DB->select('id, shipping_method_id, location_parsed, product_type_id, product_type_variant_id, rate_type, quantity_rate, dynamic_rate',
            OSC::model('shipping/rate')->getTableName(),
            ...
            null, null, 'fetch_rate_price');

        return $DB->fetchArrayAll('fetch_rate_price');
    }
}
