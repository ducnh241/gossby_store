...
namespace Kafka;
require_once(dirname(__FILE__) . '/SingletonTrait.php');
require_once(dirname(__FILE__) . '/Socket.php');
require_once(dirname(__FILE__) . '/SocketSync.php');
/**
+------------------------------------------------------------------------------
...
class Broker
{
    ...
    public function getSocket($host, $port, $modeSync)
    {
        ...
        if ($modeSync) {
            $socket = new \Kafka\SocketSync($host, $port, 0, 750000, 60);
        } else {
            $socket = new \Kafka\Socket($host, $port, 0, 750000, 60);
        }
        return $socket;
    }
