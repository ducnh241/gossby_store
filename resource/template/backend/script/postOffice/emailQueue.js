(function ($) {
    ...
    window.initPostOfficeEmailQueueBulkActionBtn = function () {
        $(this).click(function () {
    ...
    window.initPostOfficeEmailQueueGetInfo = function (link) {
        $.unwrapContent('postOfficeEmailQueueInfoFrm');
        ...
        $.wrapContent(modal, {key: 'postOfficeEmailQueueInfoFrm'});
