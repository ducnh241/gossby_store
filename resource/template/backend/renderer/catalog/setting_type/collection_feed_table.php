...
<?php if ($params['title']): ?><div class="title"><?= $params['title'] ?></div><?php endif; ?>
    <div class="collection-feed-table setting-table" data-name="config[<?= $params['key'] ?>]" data-insert-cb="catalogInitSettingCollectionFeedTable">
        <?= $this->getJSONTag(['data' => $data_setting, 'catalog_collections' => $_catalog_collections], 'collection-feed-table') ?>
    </div>
