...
<div class="block m25">
    <?php if (count($data) > 0) : ?>
        <table class="grid grid-borderless">
            <tr>
                <th style="text-align: left">Adset</th>
            ...
            ?>
                <tr>
                    <td style="text-align: left">
                        <div><b><?= $item['adset_name'] ?  $item['adset_name'] : '-' ?></b></div>
                        <div><small>ID: <?= $item['adset_id'] ?></small></div>
                    </td>
                    ...
                    <td style="text-align: right">
                        <a 
                            ...
                            href="<?php echo $this->getUrl('*/*/adTrackingAdsetDetail', [
