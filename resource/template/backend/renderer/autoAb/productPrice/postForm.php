...
$this->push([
    ...
    'selectProductTypeVariants/index.js',
], 'js');
...
<div class="post-frm p25 ab-test-product-price" style="width: 950px">
    <div class="post-frm-grid">
        <div class="post-frm-grid__main-col">
            <div class="block">
                ...
                <div class="plr20 pb20 d-flex justify-content-between">
                    <div class='wrapped-select'>
                        <select name="condition_type" id="condition_type" class="styled-input">
                            <?php foreach (Model_AutoAb_ProductPrice_Config::CONDITION_TYPES as $key => $value) : ?>
                                <option value="<?= $key ?>"
                                    <?php if ($model->data['condition_type'] === $key) : ?>
                                        selected="selected"
                                    <?php endif; ?>
                                >
                                    <?= $value ?>
                ...
                <div class="plr20 pb20">
                    <div class="title-heading">Fixed Products: (Optional)</div>
                ...
                <div id="select-product-type-variants-component"
                     class="select-product-type-variants-component plr20 pb20 pt20"
                     data-insert-cb="initSelectProductTypeVariantsComponent">
                    <?= $this->getJSONTag([
                        'variant_data' => is_array($model->data['variant_data']) ? $model->data['variant_data'] : []
                    ], 'data')
                    ?>
                ...
                <div class="plr20 pb20 pt20">
                    <div class='pb20'>
                        <strong data-insert-cb="initProductTypeVariantModal" class="text-blue underline pointer">View variant base cost config</strong>
                    </div>
    ...
    <div class="action-bar">
        ...
        <button data-id="<?= $model->getId(); ?>" type="submit" class="btn btn-primary submit-form-product-price-ab" data-insert-cb="initSubmitFormProductPriceAbtest">
            <?= $this->_('core.save') ?>
        </button>
    </div>
</div>
