...
$order_discount_codes = $order->data['discount_codes'];
?>
<table style="margin-bottom: 15px !important;<?= $params['css_attributes']['table'] ?>">
    <tr>
        <td>
            <div style="<?= $params['css_attributes']['h1'] ?>">Thank You!</div>
            <div style="<?= $params['css_attributes']['message'] ?>text-align: center !important">
                ...
                <p style="<?= $params['css_attributes']['message p'] ?>">To say thanks for shopping with us,<br />here's a <span style="color: #1688FA !important; font-weight: bold !important;"><?= $discount_code_value ?> OFF</span> your next purchase</p>
            </div>
        </td>
    </tr>
</table>
    ...
    <tr>
        <td align="center" valign="center">
            <table class="button main-action-cell" style="<?= $params['css_attributes']['table'] ?>">
                <tr>
                    <td style="<?= $params['css_attributes']['button-cell'] ?>" align="center"><a href="<?= OSC::helper('postOffice/email')->getClickUrl($this->getUrl('catalog/frontend/thankyouEmailClick', ['_o' => $order->getOrderUkey(), '_d' => $discount_code->data['discount_code']])) ?>" style="<?= $params['css_attributes']['button-cell a'] ?>">Continue Shopping</a></td>
                </tr>
            </table>
        </td>
    </tr>
</table>
<?= $this->build('catalog/email_template/html/order/summary', array_merge($params, ['customer_info_render_flag' => true, 'customer_info_render_just_address_flag' => true])) ?>
            ...
            <td style="width: 48% !important; text-align: center; padding-bottom: 30px !important;" align="center" valign="top">
                <div style="text-align: center;">
                    <div style="background-image: url(<?= OSC::helper('core/image')->imageOptimize($recommended_item->getFeaturedImageUrl(), 300, 300, true) ?>) !important; background-repeat: no-repeat !important; background-position: center center !important; background-size: contain !important;">
                        <a style="outline: 0 !important; border: none !important; text-decoration: none !important; display: block !important; height: 250px;" href="<?= OSC::helper('postOffice/email')->getClickUrl($this->getUrl('catalog/frontend/thankyouEmailClick', ['_o' => $order->getOrderUkey(), '_d' => $discount_code->data['discount_code'], '_p' => $recommended_item->getId()])) ?>" target="_blank" rel="noopener noreferrer">&nbsp;</a>
                    </div>
                    <div style="margin: 10px 0 !important;">
                        <a style="text-decoration: none !important; color: #282364 !important; <?= $params['css_attributes']['font'] ?>" href="<?= OSC::helper('postOffice/email')->getClickUrl($this->getUrl('catalog/frontend/thankyouEmailClick', ['_o' => $order->getOrderUkey(), '_d' => $discount_code->data['discount_code'], '_p' => $recommended_item->getId()])) ?>" target="_blank" rel="noopener noreferrer"><?= $recommended_item->data['title'] ?></a>
                    </div>
                    <table style="<?= $params['css_attributes']['table'] ?>max-width: 130px !important; margin: auto !important; margin-top: 10px !important;">
                        <tr>
                            <td align="center" valign="center">
                                <table class="button main-action-cell" style="<?= $params['css_attributes']['table'] ?>">
                                    <tr>
                                        <td style="<?= $params['css_attributes']['button-cell'] ?>" align="center"><a href="<?= OSC::helper('postOffice/email')->getClickUrl($this->getUrl('catalog/frontend/thankyouEmailClick', ['_o' => $order->getOrderUkey(), '_d' => $discount_code->data['discount_code'], '_p' => $recommended_item->getId()])) ?>" style="<?= $params['css_attributes']['button-cell a'] ?>">Shop Now</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
