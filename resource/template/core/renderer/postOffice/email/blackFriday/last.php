            ...
            <tr>        
                <td>          
                    <table align="center" border="0" cellpadding="0" cellspacing="0" style="background: white" width="600">            
                        <tr>              
                            <td class="top" style="max-width: 600px;width: 221px;height: 21px; padding: 15px 0">                <a class="logo" href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/?sref=6&_dcode=BF302019') ?>" title="">
                                    <img alt="" height="25" src="<?= $this->getImage('postOffice/email/blackFriday/last/41ee9069-1b99-4db7-ad7f-75ccae03fa92.png') ?>" width="112"/>
                                </a>
                            </td>
                        </tr>
                        <tr>              
                            <td>                <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/?sref=6&_dcode=BF302019') ?>" style="text-align: center" title="">
                                    <img alt="" src="<?= $this->getImage('postOffice/email/blackFriday/last/486fadd9-f1c9-42c1-945d-da32929a4aab.png') ?>" width="600"/>
                                </a>
                            </td>
                        </tr>
                        <tr>              
                                ...
                                <table align="center" border="0" cellspacing="0" class="container" role="presentation">                  
                                            ...
                                            <table align="center" border="0" cellspacing="0" role="presentation" style="padding: 30px;" width="100%">                        
                                                <tr>                          
                                                    <td align="center" style="text-align: center" valign="middle">                            
                                                        <div style="font-size: 18px;font-weight: 600;line-height: 26px;text-transform: unset;font-family: Arial, Helvetica, sans-serif;color: #282364">                              <strong style="font-weight: 500"> Hi <?= $params['first_name'] ?>!</strong>
                                                        </div>
                                                        <p style="font-family: Arial, Helvetica, sans-serif;font-style: normal;font-weight: bold;font-size: 20px;line-height: 22px;text-align: center;text-transform: uppercase;color: #282364;margin: 0;margin-top: 2%;">
                                                            Black Friday Sale is ending soon. 30% Off EVERYTHING &rsquo;til Midnight!
                                                            <br/>
                                    ...
                                    <tr>                    
                                        <td class="content">                      
                                            <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                                                <tr>                          
                                                    <td background="<?= $this->getImage('postOffice/email/blackFriday/last/82120b7d-f246-4c5f-96f3-f748773d7cf8.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/last/82120b7d-f246-4c5f-96f3-f748773d7cf8.png') ?>');background-size: cover" valign="top" width="600">                            
                                                        <!--[if gte mso 9]>
                                                                                      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                                                                          <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/last/82120b7d-f246-4c5f-96f3-f748773d7cf8.png') ?>" color="white" />
                                    ...
                                    <tr>                    
                                        <td class="content">                      
                                            <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                                                <tr>                          
                                                    <td background="<?= $this->getImage('postOffice/email/blackFriday/last/7a3545cc-1ca1-4b63-a685-000f8a0876a8.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/last/7a3545cc-1ca1-4b63-a685-000f8a0876a8.png') ?>');background-size: cover" valign="top" width="600">                            
                                                        <!--[if gte mso 9]>
                                                                                      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                                                                          <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/last/7a3545cc-1ca1-4b63-a685-000f8a0876a8.png') ?>" color="white" />
                                                                                          <v:textbox inset="0,0,0,0">
                                                                                      <![endif]-->
                                                        <table>                              
                                                            <tr>                                
                                                                            ...
                                                                            <td>                                        
                                                                                <div>                                          
                                                                                    <div>                                            
                                                                                        ...
                                                                                        <h3 class="product_name" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">                                              <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/5DC9278D6D6E8IN/18/Personalized_Mug_-_Curvy_Girls?sref=6&_dcode=BF302019') ?>" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">
                                    ...
                                    <tr>                    
                                        <td class="content">                      
                                            <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                                                <tr>                          
                                                    <td background="<?= $this->getImage('postOffice/email/blackFriday/last/884718d1-8350-42a0-b0e2-eea2680de394.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/last/884718d1-8350-42a0-b0e2-eea2680de394.png') ?>');background-size: cover" valign="top" width="600">                            
                                                        <!--[if gte mso 9]>
                                                                                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                                                                            <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/last/884718d1-8350-42a0-b0e2-eea2680de394.png') ?>" color="white" />
                                                                                            <v:textbox inset="0,0,0,0">
                                                                                        <![endif]-->
                                                        <table>                              
                                                            <tr>                                
                                                                            ...
                                                                            <td>                                        
                                                                                <div>                                          
                                                                                    <div>                                            
                                                                                        ...
                                                                                        <h3 class="product_name" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">                                              <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/5DC9278D5F0A4SW/14/Life_is_better_with_dogs?sref=6&_dcode=BF302019') ?>" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">
                                                                                                High-quality white ceramic.<br/>
                                                                                                Printed on Both Sides.<br/>
                                    ...
                                    <tr>                    
                                        <td border="0" cellpadding="0" cellspacing="0" class="content">                      
                                            <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;padding: 0">                        
                                                <tr>                          
                                                    <td background="<?= $this->getImage('postOffice/email/blackFriday/last/fd196696-08fc-48d0-b98b-b8559b379880.png') ?>" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/last/fd196696-08fc-48d0-b98b-b8559b379880.png') ?>');background-size: cover;padding: 0;" valign="middle" width="600">                            
                                                        <!--[if gte mso 9]>
                                                                                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                                                                        <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/last/fd196696-08fc-48d0-b98b-b8559b379880.png') ?>" color="white" />
                                                                                        <v:textbox inset="0,0,0,0">
                                                                                    <![endif]-->
                                                        <table border="0" cellpadding="0" cellspacing="0">                              
                                                            <tr>                                
                                                                            ...
                                                                            <td>                                        
                                                                                <div>                                          
                                                                                    <div>                                            
                                                                                        ...
                                                                                        <h3 class="product_name" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">                                              <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/5DC9278D71BC28F/2/Personalized_Mug_-_Wizard_Best_Friends?sref=6&_dcode=BF302019') ?>" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">
                                                                                                High-quality white ceramic.<br/>
                                    ...
                                    <tr>                    
                                        <td class="content">                      
                                            <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                                                <tr>                          
                                                    <td background="<?= $this->getImage('postOffice/email/blackFriday/last/489ef8bf-d721-4f94-82f6-84cd3348c810.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/last/489ef8bf-d721-4f94-82f6-84cd3348c810.png') ?>');background-size: cover" valign="top" width="600">                            
                                                        <!--[if gte mso 9]>
                                                                                  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                                                                      <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/last/489ef8bf-d721-4f94-82f6-84cd3348c810.png') ?>" color="white" />
                                                                                      <v:textbox inset="0,0,0,0">
                                                                                  <![endif]-->
                                                        <table>                              
                                                            <tr>                                
                                                                            ...
                                                                            <td>                                        
                                                                                <div>                                          
                                                                                    <div>                                            
                                                                                        ...
                                                                                        <h3 class="product_name" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">                                              <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/5DD5810976F1A72/2/Personalized_Best_Friends_Circle_Ornament_-_Best_Friends_Forever?sref=6&_dcode=BF302019') ?>" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">
                                                                                        ...
                                                                                        <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/5DD5810976F1A72/2/Personalized_Best_Friends_Circle_Ornament_-_Best_Friends_Forever?sref=6&_dcode=BF302019') ?>" style="color: #282364;text-align: center; ;font-family: Arial, Helvetica, sans-serif;font-size: 14px;text-decoration: none;font-weight:bold;display: inline-block;" target="_blank">
                                                                                            <div>
                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                        ...
                                                        <tr>                              
                                                            <td>                                
                                                                <table align="center" style="width: 130px;" valign="middle">                                  
                                                                    <tr>                                    
                                                                        <td align="center" style="height: 30px;line-height: 18px; width: 100px;text-align: center;" valign="middle">                                      <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/?sref=6&_dcode=BF302019') ?>" style="text-align: center; ;font-family: Arial, Helvetica, sans-serif;font-size: 14px;text-decoration: none;font-weight:bold;display: inline-block;color: white;" target="_blank">
                                                                                Shop Now
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <tr>                        
                                                <td class="footer" style="padding: 25px 0">
                                                    ...
                                                    <div class="footer_social" style="padding: 10px 0; margin: 0 15px">                            <a href="https://www.facebook.com/Gossby-100330011357456" style="display: inline-block">
                                                            <img alt="Facebook" border="0" src="<?= $this->getImage('postOffice/email/blackFriday/last/979eddae-504b-499d-9fad-78b717f29269.png') ?>" style="height: 15px;width: 9px"/></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
