          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" style="background: white" width="600">            
            <tr>              
              <td class="top" style="max-width: 600px;width: 221px;height: 21px; padding: 15px 0">                <a class="logo" href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/?sref=6&_dcode=BF302019') ?>" title="">
                  <img alt="" height="25" src="<?= $this->getImage('postOffice/email/blackFriday/1st/41ee9069-1b99-4db7-ad7f-75ccae03fa92.png') ?>" width="112"/>
</a>
              </td>
            </tr>
            <tr>              
              <td>                <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/?sref=6&_dcode=BF302019') ?>" style="text-align: center" title="">
                  <img alt="" src="<?= $this->getImage('postOffice/email/blackFriday/1st/486fadd9-f1c9-42c1-945d-da32929a4aab.png') ?>" width="600"/>
</a>
              </td>
            </tr>
            <tr>              
                        ...
                        <tr>                          
                          <td align="center" style="text-align: center" valign="middle">                            
                            ...
                            <p style="font-family: Arial, Helvetica, sans-serif;font-style: normal;font-weight: bold;font-size: 20px;line-height: 22px;text-align: center;text-transform: uppercase;color: #282364;margin: 0;margin-top: 2%;">
                              Gossby Black Friday Sale Starts Tomorrow.
                              <br/>
                  ...
                  <tr>                    
                    <td class="content">                      
                      <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                        <tr>                          
                          <td background="<?= $this->getImage('postOffice/email/blackFriday/1st/82120b7d-f246-4c5f-96f3-f748773d7cf8.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/1st/82120b7d-f246-4c5f-96f3-f748773d7cf8.png') ?>');background-size: cover" valign="top" width="600">                            
<!--[if gte mso 9]>
                              <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                  <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/1st/82120b7d-f246-4c5f-96f3-f748773d7cf8.png') ?>" color="white" />
...
<!--[if gte mso 9]>
                  ...
                  <tr>                    
                    <td class="content">                      
                      <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                        <tr>                          
                          <td background="<?= $this->getImage('postOffice/email/blackFriday/1st/7a3545cc-1ca1-4b63-a685-000f8a0876a8.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/1st/7a3545cc-1ca1-4b63-a685-000f8a0876a8.png') ?>');background-size: cover" valign="top" width="600">                            
<!--[if gte mso 9]>
                              <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                  <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/1st/7a3545cc-1ca1-4b63-a685-000f8a0876a8.png') ?>" color="white" />
                                  <v:textbox inset="0,0,0,0">
                              <![endif]-->
                            <table>                              
                              <tr>                                
...
<!--[if gte mso 9]>
                  ...
                  <tr>                    
                    <td class="content">                      
                      <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                        <tr>                          
                          <td background="<?= $this->getImage('postOffice/email/blackFriday/1st/884718d1-8350-42a0-b0e2-eea2680de394.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/1st/884718d1-8350-42a0-b0e2-eea2680de394.png') ?>');background-size: cover" valign="top" width="600">                            
<!--[if gte mso 9]>
                                <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                    <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/1st/884718d1-8350-42a0-b0e2-eea2680de394.png') ?>" color="white" />
                                    <v:textbox inset="0,0,0,0">
                                <![endif]-->
                            <table>                              
                              <tr>                                
                  ...
                  <tr>                    
                    <td border="0" cellpadding="0" cellspacing="0" class="content">                      
                      <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;padding: 0">                        
                        <tr>                          
                          <td height="250" background="<?= $this->getImage('postOffice/email/blackFriday/1st/fd196696-08fc-48d0-b98b-b8559b379880.png') ?>" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/1st/fd196696-08fc-48d0-b98b-b8559b379880.png') ?>');background-size: cover;padding: 0;" valign="middle" width="600">                            
<!--[if gte mso 9]>
                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                                <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/1st/fd196696-08fc-48d0-b98b-b8559b379880.png') ?>" color="white" />
                                <v:textbox inset="0,0,0,0">
                            <![endif]-->
                            <table border="0" cellpadding="0" cellspacing="0">                              
                              <tr>                                
...
<!--[if gte mso 9]>
                  ...
                  <tr>                    
                    <td class="content">                      
                      <table align="center" border="0" cellspacing="0" class="product_list" role="presentation" style="width: 600px;height: 250px;">                        
                        <tr>                          
                          <td background="<?= $this->getImage('postOffice/email/blackFriday/1st/d3ef421d-a703-4ae7-9667-2587f3a768f3.png') ?>" bgcolor="white" height="250" style="background-image: url('<?= $this->getImage('postOffice/email/blackFriday/1st/d3ef421d-a703-4ae7-9667-2587f3a768f3.png') ?>');background-size: cover" valign="top" width="600">                            
<!--[if gte mso 9]>
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:250px;">
                              <v:fill type="tile" src="<?= $this->getImage('postOffice/email/blackFriday/1st/d3ef421d-a703-4ae7-9667-2587f3a768f3.png') ?>" color="white" />
                              <v:textbox inset="0,0,0,0">
                          <![endif]-->
                            <table>                              
                              <tr>                                
                                      ...
                                      <td>                                        
                                        <div>                                          
                                          <div>                                            
                                            ...
                                            <h3 class="product_name" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">                                              <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/5DC9278D4DF0CM8/14/Wizard_Girl_and_Dog_My_Patronus_is_a_Dog?sref=6&_dcode=BF302019') ?>" style="font-size: 14px;font-weight: normal;line-height: 18px;color: #282364;font-family: Arial, Helvetica, sans-serif;margin-top: 4px;margin-bottom: 4px; text-overflow: ellipsis;overflow: hidden;word-break: break-word;">
                                                    High-quality white ceramic.<br/>
...
Skin color, hairstyle, name,  can be changed.
                                            ...
                                            <a href="<?= OSC::helper('postOffice/email')->getClickUrl(OSC::$base_url . '/5DC9278D4DF0CM8/14/Wizard_Girl_and_Dog_My_Patronus_is_a_Dog?sref=6&_dcode=BF302019') ?>" style="color: #282364;text-align: center; ;font-family: Arial, Helvetica, sans-serif;font-size: 14px;text-decoration: none;font-weight:bold;display: inline-block;" target="_blank">
                                              <div>
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                  <tr>
                                                    <td>
                      ...
                      <tr>                        
                        <td class="footer" style="padding: 25px 0">
                          ...
                          <div class="footer_social" style="padding: 10px 0; margin: 0 15px">                            <a href="https://www.facebook.com/Gossby-100330011357456" style="display: inline-block">
                              <img alt="Facebook" border="0" src="<?= $this->getImage('postOffice/email/blackFriday/1st/979eddae-504b-499d-9fad-78b717f29269.png') ?>" style="height: 15px;width: 9px"/></a>
                          </div>
                        </td>
                      </tr>
                    </table>
