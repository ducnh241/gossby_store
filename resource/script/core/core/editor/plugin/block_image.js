    ...
    window.osc_editor_plugin_block_image = function (config) {
        ...
        return {
            initialize: function () {
                ...
                this._commands.block_image = {cmd: 'blockImage', icon: 'fa fa-image'};
            ...
            extends: {
                ...
                _blockImageVerifyElement: function (node) {
                    ...
                    if (img_container.nodeName.toLowerCase() !== 'div' || img_container.childNodes.length !== 1 || img_container.firstChild.nodeName.toLowerCase() !== 'img') {
                        return false;
                    }
